...
### We have a toe in the stream of recovery.

However, these encouraging trends are driven by growth in the service sector. It produces 80% of output. Financial services, leisure and retail are the frontrunners. Great Britain needs a successful and expanding London to offset the deficit in trade of goods. Pushing so-call ‘balance’ contains important ambitions. We would be unwise to disturb the London model.

...
After a few aborted attempts to split the config into separate files, I settled on the literate-programming-with-single-file approach via [[http://pages.sachachua.com/.emacs.d/Sacha.html][Sacha Chua]].
